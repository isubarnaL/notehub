							...
							<form action="manage-insert.php" method="POST" enctype="multipart/form-data">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">College</h2>

										<p class="panel-subtitle">
											To add <code>College</code> please fill up all field.
										</p>
									</header>
										...
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
													...
													<input type="text" name="collegename" class="form-control" required="" placeholder="eg: Acme">
												</div>
											</div>
										</div>
									</div>
