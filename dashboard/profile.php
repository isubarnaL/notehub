      ...
      <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
          ...
          <section>
                ...
                $sql = "SELECT * FROM `user_info` where id = '$res_id';";
                ...
                if (isset($_POST['save'])) {
                  # code...
                  $sql = "UPDATE `user_info` SET `user_name`='".$_POST['fullname']."',`email`='".$_POST['email']."',`password`='".$_POST['password']."' WHERE `id`='$res_id'";
                  $cur = $con->query($sql);
                  if ($cur) {
                    # code...
           ...
           <div class="panel panel-default">            
            <div class="panel-body"> 
              <div  id="image-container " class="stretch">
                <img title="profile image"  data-target="#logomodal"  data-toggle="modal"  src="<?php echo 'user-image/'.$row['p_image']; ?>"  >  
              </div>
             </div>
          <ul class="list-group">
      ...
      <div class="row">    
              ...
              <div class="form-group">
                ...
                <label class="col-md-4 control-label" for=
                  ...
                  <div class="col-md-8">
                   <input type="text" name="fullname" class="form-control" required="" placeholder="Admin Name" value="<?php echo $row['user_name'];?>">
                  </div>
                </div>
              </div> 
